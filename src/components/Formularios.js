...
/* export default function Formularios() {
    ...
    const[lenguaje, setSetLenguaje] = useState("");
        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input 
                 ...
                 <p>Elige tu sabor JS Favorito</p>
                 <input type="radio" id="vanilla" name="sabor" value="vanilla" defaultChecked onChange={e => setSabor(e.target.value)}/>
                 <label htmlFor="vanilla">Vanilla</label>
                 ...
                 <label htmlFor="svelte">Svelte</label>
                 <p>Elige tu lenguaje de programación favorito</p>
                 <select name="lenguaje" onChange={(e) => setSetLenguaje(e.target.value)} defaultValue="">
                    <option value="">---</option>
                    <option value="js">JavaScript</option>
                    <option value="php">PHP</option>
                    <option value="py">Python</option>
